...
d = 16; %block size
sigma = 0.0005; %stopping criterion for sparsecoding
rc_min = 0.003; %stopping criterion for sparsecoding
...
%     [U1,Z, U] = dictionary_learning(I_rec,Im_size)
    ...
    t =cputime;
    I_out = EM4All( I_mask, mask); %This file here is a bit modified
    cputime - t
